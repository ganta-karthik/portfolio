    ...
    { label: "Interests", logoSrc: "interests.svg" },
          ...
          const projectsDetails = [
            ...
            },
            {
              ...
              subHeading:
                "Technologies Used:HTML,CSS,ReactJS,Rapid API'S,Bootstrap."
            }
          ];
          ...
          const resumeDetails = [
            <div className="resume-screen-container" key="education">
              <ResumeHeading
                heading={"Seshadri Rao Gudlavalleru Engineering College"}
                subHeading={"ARTIFICIAL INTELLIGENCE AND DATA SCIENCE"}
                fromDate={"2020"}
                toDate={"2024"}
              />
        
              <ResumeHeading
                heading={"Sri Chaitanya College"}
                subHeading={"INTERMEDIATE"}
                fromDate={"2018"}
                toDate={"2020"}
              />
              <ResumeHeading
                heading={"Ravindra Bharathi School"}
